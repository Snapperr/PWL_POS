...
class UserController extends Controller
{
    ...
    {
        $request->validate([
            // username harus diisi, berupa string, minimal 3 karakter, dan bernilai unik di table m_uer kolom username
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            // dan bernilai unik di tabel m _user kolom username kecuali untuk user dengan id yang sedang diedit
        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            if ($validator->fails()) {
                return response()->json([
                    'status' => 'false',                    // response status, false: error/gagal, true: berhasi;
